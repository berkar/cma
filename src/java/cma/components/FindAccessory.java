  ...
  FindProgressCallback
{
  ...
  /**
   ...
   cma.components.FindAccessory as a PropertyChangeListener of JFileChooser.
  ...
  /**
   Construct a search panel with start and stop actions and "attach" it to
   the specified JFileChooser component. Calls register() to establish
   cma.components.FindAccessory as a PropertyChangeListener of JFileChooser. Sets maximum
  ...
  /**
   Called by JFileChooser when a property changes. cma.components.FindAccessory listens
  ...
  class FindAction extends AbstractAction
  {
    ...
    /**
     ...
     FindAccesory.ACTION_START and cma.components.FindAccessory.ACTION_STOP.
  ...
  class FindResults extends JPanel
  {
    ...
    /**
     ...
     When an item is double-clicked the cma.components.FindAccessory controller will
